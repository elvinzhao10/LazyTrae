...
- The former documentation tree is private local material at
  `dev/docs/root/`. It is ignored by Git and is not a runtime, packaging, or
  installation dependency.

The published package entry points remain the repository README, `AGENTS.md`,
and the package READMEs until this directory gains replacement guides.

...
## v1.3.0 execution-report boundary
...
| [v1.3.2 installation and host verification](03-install-and-host-verification.md) | Which source branch, lifecycle commands, and host proof are current? |

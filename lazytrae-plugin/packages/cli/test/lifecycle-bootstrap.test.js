...
function writeFixtureFiles(root, selfTest = "process.stdout.write('self-test-ok\\n');\n") {
  ...
  fs.writeFileSync(path.join(packageRoot, 'package.json'), '{"name":"lazytrae-ai","version":"1.3.0"}\n');
...
test('parses only canonical official HTTPS source forms for the selected product', () => {
  ...
  const accepted = [
    ['https://github.com/elvinzhao10/LazyTrae', 'v1.3.0'],
    ['https://github.com/elvinzhao10/LazyTrae.git', 'v1.3.0'],
    ['https://github.com/elvinzhao10/LazyTrae/tree/release/v1.3.0', 'release/v1.3.0'],
  ];
  const rejected = [
    'http://github.com/elvinzhao10/LazyTrae',
    'https://github.com/elvinzhao10/LazyTrae/',
    'https://github.com/elvinzhao10/LazyTrae?ref=v1.3.0',
...
test('resolves, verifies, self-tests, and promotes a local fixture under an official identity', () => {
  // Given: a local Git transport containing the expected v1.3.0 package and contracts.
  const f = fixture();
...
test('repo, tag, branch, and full-SHA sources resolve through Git to the same immutable commit', () => {
  ...
  const sources = [
    'https://github.com/elvinzhao10/LazyTrae',
    'https://github.com/elvinzhao10/LazyTrae/tree/v1.3.0',
    'https://github.com/elvinzhao10/LazyTrae/tree/main',
  ];

...
function writeFixtureFiles(root, selfTest = "process.stdout.write('self-test-ok\\n');\n") {
  ...
  fs.writeFileSync(path.join(packageRoot, 'package.json'), '{"name":"lazytrae-ai","version":"1.2.2"}\n');
...
test('parses only canonical official HTTPS source forms for the selected product', () => {
  ...
  const accepted = [
    ['https://github.com/elvinzhao10/LazyTrae', 'v1.2.2'],
    ['https://github.com/elvinzhao10/LazyTrae.git', 'v1.2.2'],
    ['https://github.com/elvinzhao10/LazyTrae/tree/release/v1.2.2', 'release/v1.2.2'],
  ];
  const rejected = [
    'http://github.com/elvinzhao10/LazyTrae',
    'https://github.com/elvinzhao10/LazyTrae/',
    'https://github.com/elvinzhao10/LazyTrae?ref=v1.2.2',
...
test('resolves, verifies, self-tests, and promotes a local fixture under an official identity', () => {
  // Given: a local Git transport containing the expected v1.2.2 package and contracts.
  const f = fixture();
...
test('repo, tag, branch, and full-SHA sources resolve through Git to the same immutable commit', () => {
  ...
  const sources = [
    'https://github.com/elvinzhao10/LazyTrae',
    'https://github.com/elvinzhao10/LazyTrae/tree/v1.2.2',
    'https://github.com/elvinzhao10/LazyTrae/tree/main',
  ];
...
test('same version at a different SHA requires an exact revision confirmation', () => {
  // Given: one active v1.2.2 release and a second commit at the same mutable branch.
  const f = fixture();

...
Subcommands:
  ...
  rollback  Select the verified previous release after --yes confirmation
  prune     Remove the exact receipt-owned retained release after --yes confirmation
...
Rollback/prune/offboard/recover-bootstrap-lock: --yes
`;

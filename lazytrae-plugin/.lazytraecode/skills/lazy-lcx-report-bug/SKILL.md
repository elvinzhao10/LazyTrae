...
3. **State files:** Check `.lazytraework/state/` for relevant state.
4. **Evidence files:** Check `.lazytraework/evidence/` for context.
...
- Collecting logs and evidence from `.lazytraework/`.
